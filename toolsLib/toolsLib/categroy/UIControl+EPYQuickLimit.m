//
//  UIControl+EPYQuickLimit.m
//  EasyPay
//
//  Created by uinpay on 2019/11/8.
//  Copyright © 2019 com.easypay. All rights reserved.
//

#import "UIControl+EPYQuickLimit.h"
#import <objc/runtime.h>

//默认时间间隔
#define defaultInterval 1

@implementation UIControl (EPYQuickLimit)
...
- (void)sure_SendAction:(SEL)action to:(id)target forEvent:(UIEvent *)event {
    ...
    if ([NSStringFromClass(self.class) isEqualToString:@"UIButton"]) {
        ...
        if (self.isIgnoreEvent) {
            NSLog(@"___________= =____________");
            return;
